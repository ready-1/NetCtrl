...
urlpatterns = [
    ...
    # Port endpoints
    path('switches/<int:switch_id>/ports/', views.PortListView.as_view(), name='port-list'),
    re_path(r'^switches/(?P<switch_id>\d+)/ports/(?P<n>[\w/]+)/$', views.PortDetailView.as_view(), name='port-detail'),
]
