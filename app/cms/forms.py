"""
Form classes for the CMS application.

This module defines forms for various CMS operations:
- Document forms for creating, editing, and managing document versions
- File management forms for attaching files to documents
"""
