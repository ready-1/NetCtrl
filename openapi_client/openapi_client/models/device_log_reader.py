...
class DeviceLogReader(BaseModel):
    """
    DeviceLogReader
    """  # noqa: E501

    logs: Optional[List[StrictStr]] = Field(
        default=None, description="Device Logs in buffer"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"logs": obj.get("logs")})
        return _obj
