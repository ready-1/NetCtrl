...
class TracerouteStatus(BaseModel):
    ...
    state: Optional[StrictInt] = Field(
        default=None,
        description="Traceroute Test State:   * `0` = PT_SUCCESS   * `1` = PT_IN_PROGRESS   * `2` = PT_FAILURE ",
    )
    traceroute_msg: Optional[StrictStr] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"state": obj.get("state"), "tracerouteMsg": obj.get("tracerouteMsg")}
        )
        return _obj
