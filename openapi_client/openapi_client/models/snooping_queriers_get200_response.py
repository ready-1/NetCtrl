...
class SnoopingQueriersGet200Response(BaseModel):
    """
    SnoopingQueriersGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    snooping_queriers: Optional[SnoopingQueriersGet] = None
    __properties: ClassVar[List[str]] = ["resp", "snooping_queriers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of snooping_queriers
        if self.snooping_queriers:
            _dict['snooping_queriers'] = self.snooping_queriers.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snooping_queriers": SnoopingQueriersGet.from_dict(obj["snooping_queriers"]) if obj.get("snooping_queriers") is not None else None
        })
        return _obj
