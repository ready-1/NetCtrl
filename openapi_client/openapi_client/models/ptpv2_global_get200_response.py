...
class Ptpv2GlobalGet200Response(BaseModel):
    """
    Ptpv2GlobalGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    ptpv2_global: Optional[Ptpv2Global] = None
    __properties: ClassVar[List[str]] = ["resp", "ptpv2_global"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ptpv2_global
        if self.ptpv2_global:
            _dict['ptpv2_global'] = self.ptpv2_global.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ptpv2_global": Ptpv2Global.from_dict(obj["ptpv2_global"]) if obj.get("ptpv2_global") is not None else None
        })
        return _obj
