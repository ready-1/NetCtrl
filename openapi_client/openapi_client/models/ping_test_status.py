...
class PingTestStatus(BaseModel):
    ...
    state: Optional[StrictInt] = Field(
        default=None,
        description="Ping Test State:   * `0` = PT_SUCCESS   * `1` = PT_IN_PROGRESS   * `2` = PT_FAILURE ",
    )
    ping_msg: Optional[StrictStr] = Field(
        default=None, description="Response for Ping message.", alias="pingMsg"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"state": obj.get("state"), "pingMsg": obj.get("pingMsg")}
        )
        return _obj
