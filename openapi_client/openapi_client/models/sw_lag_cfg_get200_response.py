...
class SwLagCfgGet200Response(BaseModel):
    ...
    switch_config_lag_group: Optional[SwLagCfg] = Field(
        default=None, alias="switchConfigLagGroup"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "switchConfigLagGroup": (
                    SwLagCfg.from_dict(obj["switchConfigLagGroup"])
                    if obj.get("switchConfigLagGroup") is not None
                    else None
                ),
            }
        )
