...
class LldpRemoteDevicesMgmtAddressesInner(BaseModel):
    """
    LldpRemoteDevicesMgmtAddressesInner
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="List of types")
    address: Optional[StrictStr] = Field(default=None, description="List of IP addresses")
