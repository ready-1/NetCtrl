...
class SystemConfigPostRequest(BaseModel):
    """
    SystemConfigPostRequest
    """ # noqa: E501
    system_config: Optional[SystemConfigPost] = None
    __properties: ClassVar[List[str]] = ["system_config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "system_config": SystemConfigPost.from_dict(obj["system_config"]) if obj.get("system_config") is not None else None
        })
        return _obj
