...
class DeviceCableTest(BaseModel):
    ...
    status: Optional[StrictInt] = Field(
        default=None,
        description="Status of the cable test:   * `0` = Untested   * `1` = Fail   * `2` = Normal   * `3` = Open   * `4` = Short   * `5` = Open Short   * `6` = Cross Talk   * `7` = No Cable ",
    )
    len_known: Optional[StrictInt] = Field(
        default=None,
        description="Length of Cable in meters. (0 if not known)",
        alias="lenKnown",
    )
    shortest_len: Optional[StrictInt] = Field(
        default=None,
        description="Cable length range shorter limit in meters.",
        alias="shortestLen",
    )
    longest_len: Optional[StrictInt] = Field(
        default=None,
        description="Cable length range longer limit in meters.",
        alias="longestLen",
    )
    cable_failure_len: Optional[StrictInt] = Field(
        default=None,
        description="Distance along cable to detected fault.",
        alias="cableFailureLen",
    )
