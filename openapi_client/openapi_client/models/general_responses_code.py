...
class GeneralResponsesCode(BaseModel):
    """
    GeneralResponsesCode
    """ # noqa: E501
    status: Optional[StrictStr] = None
    resp_code: Optional[StrictInt] = Field(default=None, alias="respCode")
    resp_msg: Optional[StrictStr] = Field(default=None, alias="respMsg")
    __properties: ClassVar[List[str]] = ["status", "respCode", "respMsg"]
