...
class DualImageStatusGet200Response(BaseModel):
    ...
    dual_image_status: Optional[DualImageStatus] = Field(
        default=None, alias="dualImageStatus"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "dualImageStatus": (
                    DualImageStatus.from_dict(obj["dualImageStatus"])
                    if obj.get("dualImageStatus") is not None
                    else None
                ),
            }
        )
