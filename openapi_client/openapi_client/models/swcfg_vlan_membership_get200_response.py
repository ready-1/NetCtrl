...
class SwcfgVlanMembershipGet200Response(BaseModel):
    ...
    vlan_membership: Optional[SwcfgVlanMembership] = Field(
        default=None, alias="vlanMembership"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "vlanMembership": (
                    SwcfgVlanMembership.from_dict(obj["vlanMembership"])
                    if obj.get("vlanMembership") is not None
                    else None
                ),
            }
        )
