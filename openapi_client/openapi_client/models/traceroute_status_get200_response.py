...
class TracerouteStatusGet200Response(BaseModel):
    ...
    traceroute_info: Optional[TracerouteStatus] = Field(
        default=None, alias="tracerouteInfo"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "tracerouteInfo": (
                    TracerouteStatus.from_dict(obj["tracerouteInfo"])
                    if obj.get("tracerouteInfo") is not None
                    else None
                ),
            }
        )
