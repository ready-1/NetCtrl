...
class SwcfgVlanMembershipTrafficPrioPortMemInner(BaseModel):
    """
    SwcfgVlanMembershipTrafficPrioPortMemInner
    """ # noqa: E501
    portid: Optional[StrictInt] = Field(default=None, description="Traffic priority and Port VLAN IDs (PVID) for these physical ports")
