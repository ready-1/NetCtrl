...
class DeviceCableTestGet200Response(BaseModel):
    ...
    cable_test_status: Optional[DeviceCableTest] = Field(
        default=None, alias="cableTestStatus"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "cableTestStatus": (
                    DeviceCableTest.from_dict(obj["cableTestStatus"])
                    if obj.get("cableTestStatus") is not None
                    else None
                ),
            }
        )
