...
class SwcfgVlanGet200Response(BaseModel):
    ...
    switch_config_vlan: Optional[SwcfgVlan] = Field(
        default=None, alias="switchConfigVlan"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "switchConfigVlan": (
                    SwcfgVlan.from_dict(obj["switchConfigVlan"])
                    if obj.get("switchConfigVlan") is not None
                    else None
                ),
            }
        )
