...
class SwcfgPortGet200Response(BaseModel):
    ...
    switch_port_config: Optional[SwcfgPort] = Field(
        default=None, alias="switchPortConfig"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "switchPortConfig": (
                    SwcfgPort.from_dict(obj["switchPortConfig"])
                    if obj.get("switchPortConfig") is not None
                    else None
                )
            }
        )
