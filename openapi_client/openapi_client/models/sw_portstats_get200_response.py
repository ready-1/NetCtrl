...
class SwPortstatsGet200Response(BaseModel):
    ...
    switch_stats_port: Optional[SwPortstats] = Field(
        default=None, alias="switchStatsPort"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "switchStatsPort": (
                    SwPortstats.from_dict(obj["switchStatsPort"])
                    if obj.get("switchStatsPort") is not None
                    else None
                ),
            }
        )
