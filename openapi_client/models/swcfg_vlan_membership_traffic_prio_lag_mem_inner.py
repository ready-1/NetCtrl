...
class SwcfgVlanMembershipTrafficPrioLagMemInner(BaseModel):
    """
    SwcfgVlanMembershipTrafficPrioLagMemInner
    """ # noqa: E501
    portid: Optional[StrictInt] = Field(default=None, description="Traffic priority and Port VLAN IDs (PVID) for these LAG ports.")
