...
class SwcfgVlanMembershipPvidMembersInner(BaseModel):
    """
    SwcfgVlanMembershipPvidMembersInner
    """ # noqa: E501
    portid: Optional[Annotated[int, Field(le=4093, strict=True, ge=1)]] = Field(default=None, description="Port VLAN IDs (PVID) assignments for these port interfaces.")
    __properties: ClassVar[List[str]] = ["portid"]
