...
class FdbStatsGet200Response(BaseModel):
    """
    FdbStatsGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    fdb_stats: Optional[FdbStatsGet] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of fdb_stats
        if self.fdb_stats:
            _dict['fdb_stats'] = self.fdb_stats.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fdb_stats": FdbStatsGet.from_dict(obj["fdb_stats"]) if obj.get("fdb_stats") is not None else None
        })
        return _obj
