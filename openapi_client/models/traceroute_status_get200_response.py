...
class TracerouteStatusGet200Response(BaseModel):
    """
    TracerouteStatusGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    traceroute_info: Optional[TracerouteStatus] = Field(default=None, alias="tracerouteInfo")
    __properties: ClassVar[List[str]] = ["resp", "tracerouteInfo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of traceroute_info
        if self.traceroute_info:
            _dict['tracerouteInfo'] = self.traceroute_info.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tracerouteInfo": TracerouteStatus.from_dict(obj["tracerouteInfo"]) if obj.get("tracerouteInfo") is not None else None
        })
        return _obj
