...
class DeviceLogReaderGet200Response(BaseModel):
    """
    DeviceLogReaderGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    log_reader: Optional[DeviceLogReader] = Field(default=None, alias="logReader")
    __properties: ClassVar[List[str]] = ["resp", "logReader"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of log_reader
        if self.log_reader:
            _dict['logReader'] = self.log_reader.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logReader": DeviceLogReader.from_dict(obj["logReader"]) if obj.get("logReader") is not None else None
        })
        return _obj
