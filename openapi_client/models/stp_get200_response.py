...
class StpGet200Response(BaseModel):
    """
    StpGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    spanning_tree: Optional[Stp] = Field(default=None, alias="spanningTree")
    __properties: ClassVar[List[str]] = ["resp", "spanningTree"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of spanning_tree
        if self.spanning_tree:
            _dict['spanningTree'] = self.spanning_tree.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spanningTree": Stp.from_dict(obj["spanningTree"]) if obj.get("spanningTree") is not None else None
        })
        return _obj
