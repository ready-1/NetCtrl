...
class PoeConfigGet200Response(BaseModel):
    """
    PoeConfigGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    poe_config: Optional[PoeConfigGet] = None
    __properties: ClassVar[List[str]] = ["resp", "poe_config"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of poe_config
        if self.poe_config:
            _dict['poe_config'] = self.poe_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "poe_config": PoeConfigGet.from_dict(obj["poe_config"]) if obj.get("poe_config") is not None else None
        })
        return _obj
