...
class DualImageStatusGet200Response(BaseModel):
    """
    DualImageStatusGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    dual_image_status: Optional[DualImageStatus] = Field(default=None, alias="dualImageStatus")
    __properties: ClassVar[List[str]] = ["resp", "dualImageStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dual_image_status
        if self.dual_image_status:
            _dict['dualImageStatus'] = self.dual_image_status.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dualImageStatus": DualImageStatus.from_dict(obj["dualImageStatus"]) if obj.get("dualImageStatus") is not None else None
        })
        return _obj
