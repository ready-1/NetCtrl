...
class SwcfgPortGet200Response(BaseModel):
    """
    SwcfgPortGet200Response
    """ # noqa: E501
    switch_port_config: Optional[SwcfgPort] = Field(default=None, alias="switchPortConfig")
    __properties: ClassVar[List[str]] = ["switchPortConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "switchPortConfig": SwcfgPort.from_dict(obj["switchPortConfig"]) if obj.get("switchPortConfig") is not None else None
        })
        return _obj
