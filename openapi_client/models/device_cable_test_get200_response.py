...
class DeviceCableTestGet200Response(BaseModel):
    """
    DeviceCableTestGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    cable_test_status: Optional[DeviceCableTest] = Field(default=None, alias="cableTestStatus")
    __properties: ClassVar[List[str]] = ["resp", "cableTestStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of cable_test_status
        if self.cable_test_status:
            _dict['cableTestStatus'] = self.cable_test_status.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cableTestStatus": DeviceCableTest.from_dict(obj["cableTestStatus"]) if obj.get("cableTestStatus") is not None else None
        })
        return _obj
