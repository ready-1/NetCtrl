...
class ActiveImageGet200Response(BaseModel):
    """
    ActiveImageGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    active_image: Optional[ActiveImageGet] = None
    __properties: ClassVar[List[str]] = ["resp", "active_image"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "active_image": ActiveImageGet.from_dict(obj["active_image"]) if obj.get("active_image") is not None else None
        })
        return _obj
