...
class DeviceNameGet200Response(BaseModel):
    """
    DeviceNameGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    device_name: Optional[DeviceName] = Field(default=None, alias="deviceName")
    __properties: ClassVar[List[str]] = ["resp", "deviceName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of device_name
        if self.device_name:
            _dict['deviceName'] = self.device_name.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deviceName": DeviceName.from_dict(obj["deviceName"]) if obj.get("deviceName") is not None else None
        })
        return _obj
