...
class SystemRfc1213Get200Response(BaseModel):
    """
    SystemRfc1213Get200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    system_rfc1213: Optional[SystemRfc1213Get] = None
    __properties: ClassVar[List[str]] = ["resp", "system_rfc1213"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "system_rfc1213": SystemRfc1213Get.from_dict(obj["system_rfc1213"]) if obj.get("system_rfc1213") is not None else None
        })
        return _obj
