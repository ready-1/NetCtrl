...
class HostTable(BaseModel):
    ...
    mac_addr: Optional[StrictStr] = Field(default=None, description="MAC Address", alias="macAddr")
    vlan_id: Optional[Annotated[int, Field(le=4096, strict=True, ge=1)]] = Field(default=None, description="VLAN ID", alias="vlanId")
