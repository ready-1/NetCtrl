...
class Dot1dBaseConfigGet200Response(BaseModel):
    """
    Dot1dBaseConfigGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    dot1d_base_config: Optional[Dot1dBaseConfig] = None
    __properties: ClassVar[List[str]] = ["resp", "dot1d_base_config"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dot1d_base_config
        if self.dot1d_base_config:
            _dict['dot1d_base_config'] = self.dot1d_base_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dot1d_base_config": Dot1dBaseConfig.from_dict(obj["dot1d_base_config"]) if obj.get("dot1d_base_config") is not None else None
        })
        return _obj
