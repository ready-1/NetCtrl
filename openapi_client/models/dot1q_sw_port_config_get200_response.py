...
class Dot1qSwPortConfigGet200Response(BaseModel):
    """
    Dot1qSwPortConfigGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    dot1q_sw_port_config: Optional[Dot1qSwPortConfigGet] = None
    __properties: ClassVar[List[str]] = ["resp", "dot1q_sw_port_config"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dot1q_sw_port_config
        if self.dot1q_sw_port_config:
            _dict['dot1q_sw_port_config'] = self.dot1q_sw_port_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dot1q_sw_port_config": Dot1qSwPortConfigGet.from_dict(obj["dot1q_sw_port_config"]) if obj.get("dot1q_sw_port_config") is not None else None
        })
        return _obj
