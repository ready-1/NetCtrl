...
class ConfigFileCompareGet200Response(BaseModel):
    """
    ConfigFileCompareGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    config_file_compare: Optional[ConfigFileCompare] = None
    __properties: ClassVar[List[str]] = ["resp", "config_file_compare"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of config_file_compare
        if self.config_file_compare:
            _dict['config_file_compare'] = self.config_file_compare.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config_file_compare": ConfigFileCompare.from_dict(obj["config_file_compare"]) if obj.get("config_file_compare") is not None else None
        })
        return _obj
