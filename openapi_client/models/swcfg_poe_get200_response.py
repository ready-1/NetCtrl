...
class SwcfgPoeGet200Response(BaseModel):
    """
    SwcfgPoeGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    poe_port_config: Optional[SwcfgPoe] = Field(default=None, alias="poePortConfig")
    __properties: ClassVar[List[str]] = ["resp", "poePortConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of poe_port_config
        if self.poe_port_config:
            _dict['poePortConfig'] = self.poe_port_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "poePortConfig": SwcfgPoe.from_dict(obj["poePortConfig"]) if obj.get("poePortConfig") is not None else None
        })
        return _obj
