...
class SwcfgVlanMembershipGet200Response(BaseModel):
    """
    SwcfgVlanMembershipGet200Response
    """ # noqa: E501
    resp: Optional[GeneralResponsesCode] = None
    vlan_membership: Optional[SwcfgVlanMembership] = Field(default=None, alias="vlanMembership")
    __properties: ClassVar[List[str]] = ["resp", "vlanMembership"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of vlan_membership
        if self.vlan_membership:
            _dict['vlanMembership'] = self.vlan_membership.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vlanMembership": SwcfgVlanMembership.from_dict(obj["vlanMembership"]) if obj.get("vlanMembership") is not None else None
        })
        return _obj
