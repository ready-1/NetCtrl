...
class TestAutoVoipCfgPost(unittest.TestCase):
    """AutoVoipCfgPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoVoipCfgPost:
        """Test AutoVoipCfgPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoVoipCfgPost`
        """
        model = AutoVoipCfgPost()
        if include_optional:
