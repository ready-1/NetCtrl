...
class TestSwLagCfgGet200Response(unittest.TestCase):
    """SwLagCfgGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwLagCfgGet200Response:
        """Test SwLagCfgGet200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SwLagCfgGet200Response`
        """
        model = SwLagCfgGet200Response()
        if include_optional:
    ...
    def testSwLagCfgGet200Response(self):
        """Test SwLagCfgGet200Response"""
