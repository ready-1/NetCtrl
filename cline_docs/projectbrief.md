...
- **Frontend**: React with a responsive, mobile-first design.
...
- Deliver a responsive, user-friendly interface optimized for mobile devices.
...
## Deliverables
- **Source Code**: Backend (FastAPI), frontend (React), and database schema.
...
- **MVP1: Working Docker Environment with Login, Registration, and Basic User Management API (Weeks 1-2)**:
  ...
  - Develop React login and registration screens.
...
- **MVP4: Static Page for GitHub Issue Submission (Weeks 7-8)**:
  ...
  - Develop frontend page for authenticated users to submit issues via the backend endpoint.
...
## Constraints
- Tech stack: Postgres, FastAPI with FastAPI Users, NGINX, React, Docker.
...
- **Frontend Developer**: React, JavaScript, responsive design skills.
- **DevOps Engineer**: Docker, NGINX, deployment knowledge.
...
## Documentation
- **Deployment Instructions**: Docker setup guide.
